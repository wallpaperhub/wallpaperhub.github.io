<title>Understanding Background Checks: What They Include</title>
                    <meta name="description" content="Explore what a background check entails, including identity verification, criminal history, and employment verification. Get informed on how these checks impact hiring and tenancy decisions in a concise and clear manner.">
                    <meta name="keywords" content="what does a background check consist of">
                </head>
                <body>
                ...
                <ul class="breadcrumb" itemscope itemtype="https://schema.org/BreadcrumbList">
                    ...
                    <li itemprop="itemListElement" itemscope
                        itemtype="https://schema.org/ListItem">
                        <a itemprop="item" href="/background/what-does-a-background-check-consist-of">
                            <span itemprop="name">what does a background check consist of</span></a>
                        <meta itemprop="position" content="3" />
                    </li>
                </ul>
                <h1>Understanding Background Checks: What They Include</h1>
                <p>A background check typically consists of verifying an individual's identity, checking criminal history, examining credit reports, and confirming employment and education qualifications. It may also include social media scrutiny and reference checks to ensure a comprehensive assessment of the person's history and background for employment or tenancy purposes.</p>
