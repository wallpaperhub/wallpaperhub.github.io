<title>Understanding Criminal Background Checks: What's Included</title>
                    <meta name="description" content="Discover what shows up on a criminal background check. Learn about arrests, convictions, and other relevant information that could impact employment and housing opportunities. Stay informed to make better decisions with your background checks!">
                    <meta name="keywords" content="what shows up on a criminal background check">
                </head>
                <body>
                ...
                <ul class="breadcrumb" itemscope itemtype="https://schema.org/BreadcrumbList">
                    ...
                    <li itemprop="itemListElement" itemscope
                        itemtype="https://schema.org/ListItem">
                        <a itemprop="item" href="/background/what-shows-up-on-a-criminal-background-check">
                            <span itemprop="name">what shows up on a criminal background check</span></a>
                        <meta itemprop="position" content="3" />
                    </li>
                </ul>
                <h1>Understanding Criminal Background Checks: What's Included</h1>
                <p>A criminal background check typically reveals a person's criminal history, including arrests, convictions, and pending charges. It may also show sex offender status, civil judgments, and, in some cases, employment history. Variations in the extent of information may occur based on state laws and the type of check conducted.</p>
                <div class='container'><div itemscope itemtype="https://schema.org/ImageObject">
                                ...
                                <meta itemprop="name alternativeheadline" content="What Shows Up On A Criminal Background Check? - CountyOffice.org">
                                <img itemprop="contentUrl url" src='https://i.ytimg.com/vi/rJgb5g_CkK0/maxresdefault.jpg' alt='What Shows Up On A Criminal Background Check? - CountyOffice.org'>
                                <meta itemprop="representativeOfPage" content="True">
                                <meta itemprop="width" content="1280">
                                ...
                                <a href='https://i.ytimg.com/vi/rJgb5g_CkK0/maxresdefault.jpg' target='_blank' rel='nofollow' download>Download</a>
                            </div><div itemscope itemtype="https://schema.org/ImageObject">
